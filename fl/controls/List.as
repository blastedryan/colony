package fl.controls
{
   ...
   public class List extends SelectableList implements IFocusManagerComponent
   {
      ...
      override protected function drawList() : void
      {
         ...
         _loc2_ = uint(Math.floor(_verticalScrollPosition / rowHeight));
         _loc3_ = uint(Math.min(length,_loc2_ + rowCount + 1));
      ...
      public function set rowCount(param1:uint) : void
      {
         ...
         _loc3_ = _horizontalScrollPolicy == ScrollPolicy.ON || _horizontalScrollPolicy == ScrollPolicy.AUTO && _maxHorizontalScrollPosition > 0?15:Number(0);
      ...
      override public function scrollToIndex(param1:int) : void
      {
         ...
         var _loc3_:* = 0;
         drawNow();
         _loc2_ = uint(Math.floor((_verticalScrollPosition + availableHeight) / rowHeight) - 1);
         _loc3_ = uint(Math.ceil(_verticalScrollPosition / rowHeight));
         if(param1 < _loc3_)
         {

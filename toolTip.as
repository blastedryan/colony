package
{
   ...
   public class toolTip extends Sprite
   {
      ...
      public function toolTip(s:Stage, r:Object, offSetX:Number = 15, offSetSize:Number = 150)
      {
         super();
         errorTip = false;
         theStage = s;
         ...
         t_name.border = true;
         t_name.borderColor = 1118481;
         t_name.background = true;
         t_name.backgroundColor = 1710618;

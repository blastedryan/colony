package ColonyFinal_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      {
         var r:URLRequest = new URLRequest("http://armorgames.com/play/4264/colony");
      ...
      public function checkNameValid(a:String) : *
      {
         ...
         var nuller:Boolean = false;
         for(var nn:int = 0; nn < cahL; nn++)
         {
      ...
      public function doChat(t:String, n:String, c:uint, d:String = null) : *
      {
         ...
         chatText.y = 0;
         for(var i:int = 0; i < chatBox.innerBox.numChildren; i++)
         {
      ...
      {
         var i:* = undefined;
         var chat_pColor:* = undefined;
         var chat_pName:* = undefined;
         for(i in allPlayers)
         {
      ...
      {
         var nhj:* = undefined;
         var ayt:Boolean = false;
         var d2:* = undefined;
         var dv2:Number = NaN;
         var alreadyGotten:Boolean = false;
         var hg:* = undefined;
         var d:* = undefined;
      ...
      public function screenScroll(event:Event) : void
      {
         ...
         else if(mouseY <= 400 && mouseX > maxBound || screenGoRight)
         {
         ...
         if(stage.focus == this)
         {
            ...
            for(juh in hotkeyArray)
            {
               if(event.keyCode == hotkeyArray[juh])
               {
                  ...
                  else if(gameKon.selectedBuilding.ownBy == gameKon.playerNow)
                  {
                     hotbutArray[juh].doReal();
                  }
               }
            ...
            if(stage.focus == chatPanel)
            {
               ...
               if(chatPanel.text != "" && chatPanel.text != "< Type here or press Enter to chat >")
               {
                  ...
                  else
                  {
                     ...
                     else if(chatPanel.text.indexOf("/add") == 0)
                     {
                     ...
                     else if(chatPanel.text.indexOf("/remove") == 0)
                     {
                     ...
                     else if(chatPanel.text.indexOf("/friendlist") == 0)
                     {
                     ...
                     else if(chatPanel.text.indexOf("/block") == 0)
                     {
                        mpKon.blockBuddy(chatPanel.text.substr(7),true);
                     }
                     else if(chatPanel.text.indexOf("/unblock") == 0)
                     {
      ...
      {
         var butOn:Boolean = false;
         for(var fg:int = 0; fg < 6; fg++)
         {
            butOn = false;
            switch(fg)
            {
      ...
      {
         var urlAGL:String = "http://ArmorGames.com";
      ...
      function __setProp_button_single_MENU_MENU_18() : *
      {
      ...
      function __setProp_button_multi_MENU_MENU_18() : *
      {
      ...
      function __setProp_button_mission_MENU_MENU_18() : *
      {
      ...
      function __setProp_button_link_MENU_MENU_18() : *
      {
      ...
      function __setProp_combo1_MENU_MENU_19() : *
      {
         var collObj0:DataProvider = null;
      ...
      function __setProp_sxB_4_MENU_MENU_19() : *
      {
      ...
      function __setProp_sxB_5_MENU_MENU_19() : *
      {
      ...
      function __setProp_sxB_3_MENU_MENU_19() : *
      {
      ...
      function __setProp_sxB_2_MENU_MENU_19() : *
      {
      ...
      function __setProp_sxB_1_MENU_MENU_19() : *
      {
      ...
      function __setProp_xb_back_MENU_MENU_19() : *
      {
      ...
      function __setProp_xb_back2_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_1_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_2_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_3_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_4_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_5_MENU_MENU_20() : *
      {
      ...
      function __setProp_butmis_6_MENU_MENU_20() : *
      {
      ...
      function __setProp_j_server1_MENU_MENU_21() : *
      {
      ...
      function __setProp_xb_back3_MENU_MENU_21() : *
      {
      ...
      function __setProp_j_server0_MENU_MENU_21() : *
      {
      ...
      function __setProp_j_server2_MENU_MENU_21() : *
      {
      ...
      function __setProp_xb_back6_MENU_MENU_22() : *
      {
      ...
      function __setProp_goAg_MENU_MENU_22() : *
      {
      ...
      function __setProp_but_guest_MPCONNECT_Go_25() : *
      {
      ...
      function __setProp_but_exit_MPCONNECT_Go_25() : *
      {
      ...
      function __setProp_but_login_MPCONNECT_Go_25() : *
      {
      ...
      function __setProp_but_register_MPCONNECT_Go_25() : *
      {
      ...
      function __setProp_reMe_MPCONNECT_Go_25() : *
      {
      ...
      function __setProp_but_register2_MPCONNECT_Go_26() : *
      {
      ...
      function __setProp_but_exit2_MPCONNECT_Go_26() : *
      {
      ...
      function __setProp_but_login4_MPCONNECT_Go_27() : *
      {
      ...
      function __setProp_but_exit3_MPCONNECT_Go_27() : *
      {
      ...
      function __setProp_but_login3_MPCONNECT_Go_27() : *
      {
      ...
      function __setProp_xb_back7_MPCONNECT_Layer3_28() : *
      {
      ...
      function __setProp_goAg2_MPCONNECT_Layer3_28() : *
      {
      ...
      function __setProp_button_res_POST_Layer1_33() : *
      {
      ...
      function frame5() : *
      {
         ...
         colorForm = new Array(16777215,16711680,39423,16763904,385051);

package
{
   public class unitKon
   {
      ...
      public static function resetAll(p1:playerKon, p3:playerKon) : void
      {
         ...
         unitBody.armorCrossCheck[3] = new Array(0.9,0.7,0.6,0.7,0.3);
      ...
      private static function sortDisplay(u:unitBody) : *
      {
         ...
         for(h in displayArray)
         {
            ...
            {
               retter = uint(retter + 1);
               displayArray.push({
                  "unit":u,
                  "posY":u.y
               });
               retter = uint(displayArray.length - (1 + h));
               return retter;
            }
         }
         displayArray.push({
      ...
      public static function killOffUnit(uID:String, theKiller:playerKon = null, randNummer:uint = 0) : void
      {
         ...
         var u:* = undefined;
         var useVal:* = NaN;
         var randAdd:Number = NaN;
         var playerExGo:int = 0;

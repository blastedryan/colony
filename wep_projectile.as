package
{
   ...
   public class wep_projectile extends displayBody
   {
      ...
      public function wep_projectile(id:uint, u:unitBody, dam:Number, s:Number, ex:Object, shock:Boolean, splash:Number, heal:Boolean, wepType:uint, trail:uint = 0, sound:uint = 0)
      {
         super();
         speed = s;
         EX = ex;

   ...
   public class mpKon
   {
      ...
      private static function repEx(evt:SFSEvent) : void
      {
         ...
         else
         {
            ...
            roomId = o[1];
            optionId = Number(o[2]);
            pos = uint(uint(Number(o[3])));
            callCommand = uint(uint(Number(o[4])));
            ...
            trace("EVENT RECIEVED: Create " + optionData.LIST[optionId].nameLabel + " // From Position" + pos);
         }
      }
